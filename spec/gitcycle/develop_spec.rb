...
describe Gitcycle do
  ...
  describe "#develop" do
    ...
    context "with a lighthouse ticket" do
      ...
      before :each do
        webmock(:branch, :post, webmock_post_merge)
        webmock(:branch, :put,  webmock_put_merge)
      end
      ...
      context "when the user accepts the default branch" do
        ...
        it "requests and receives parameters that match the json spec" do
          validate_schema(:branch, :post, webmock_post_merge)
          validate_schema(:branch, :put,  webmock_put_merge)
        end
      ...
      context "when the user changes the target branch" do
        ...
        let(:webmock_put_merge_with_source) do
          Gitcycle::Util.deep_merge(webmock_put_merge,
        ...
        before :each do
          ...
          webmock(:branch, :put, webmock_put_merge_with_source)
        end
        ...
        it "requests and receives parameters that match the json spec" do
          validate_schema(:branch, :put, webmock_put_merge_with_source)
        end
